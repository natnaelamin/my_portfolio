  ...
  return (
    <main className="h-screen w-screen relative">
      <div className="flex items-center w-full h-full bg-cover bg-center" style={{backgroundImage: `url(${mainBg.src})`}}>
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <div className="flex-col md:flex-row hidden md:flex gap-5">
            ...
            <Link href="/my-projects" className="rounded-[20px] group relative bg-transparent border border-white px-5 py-3 text-white text-large max-w-[200px]">
              <div className="absolute rounded-[20px] z-[1] bg-white inset-0 opacity-0 group-hover:opacity-20" />
                My projects
            </Link>
            <Link href="/contact-me" className="rounded-[20px] group relative bg-transparent border border-white px-5 py-3 text-white text-large max-w-[200px]">
              <div className="absolute rounded-[20px] z-[1] bg-white inset-0 opacity-0 group-hover:opacity-20" />
                Contact me
            </Link>
          </div>
      ...
      <div className="absolute flex bottom-10 z-[20] right-5 md:hidden gap-5">
        ...
        <Link href="/my-projects" className="rounded-[20px] group bg-transparent border border-white px-5 py-3 text-white text-large max-w-[200px]">
            My projects
        </Link>
        <Link href="/contact-me" className="rounded-[20px] group bg-transparent border border-white px-5 py-3 text-white text-large max-w-[200px]">
            Contact me
        </Link>
      </div>
